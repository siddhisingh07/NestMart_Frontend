...
const Footer = () => {
  const quickLinks = [
    { name: "Home", to: "/", icon: <BsHouseExclamation className="inline-block mr-2 text-gray-700" /> },
    { name: "All Products", to: "/products", icon: <BsCart className="inline-block mr-2 text-gray-700" /> },
    { name: "Hot Deals", to: "/products", icon: <BsLightningCharge className="inline-block mr-2 text-gray-700" /> },
    { name: "Best Selling Products", to: "/products", icon: <BsStar className="inline-block mr-2 text-gray-700" /> },
    { name: "Recently Added", to: "/products", icon: <BsClockHistory className="inline-block mr-2 text-gray-700" /> },
  ];
  ...
  const accountLinks = [
    { name: "Login", to: "/login", icon: <BsHouseExclamation className="inline-block mr-2 text-gray-700" /> },
    { name: "Sign up", to: "/signup", icon: <BsCart className="inline-block mr-2 text-gray-700" /> },
    { name: "Privacy Policy", to: "#", icon: <MdPrivacyTip className="inline-block mr-2 text-gray-700" /> },
    { name: "FAQs", to: "#", icon: <FaQq className="inline-block mr-2 text-gray-700" /> },
    { name: "Delivery Information", to: "#", icon: <MdDeliveryDining className="inline-block mr-2 text-gray-700" /> },
  ];
    ...
    return items.map((item, index) => (
      <li key={index} className="mb-1 text-gray-600">
        {item.to ? (
          <Link
            to={item.to}
            className="flex items-center hover:text-green transition-all duration-150"
          >
            {item.icon} {item.name}
          </Link>
        ) : (
  ...
  return (
    <div className="px-4 md:px-10 lg:px-28 bg-light_green pt-14 pb-8 gap-10">
      <div className="flex flex-col md:flex-col justify-between gap-10 lg:gap-5 lg:flex-row ">
        <div className="w- md:w-full lg:w-1/3">
      ...
      <p className="text-center text-gray-700 font-light">
        Copyright 2025 ©{" "}
        <Link className="text-green font-normal" to="/">
          Nest Mart
        </Link>{" "}
        All Right Reserved.
      </p>
      <p className="text-base text-gray-700 text-center font-light">
        Developed by{" "}
        <Link className="text-green font-normal" to="https://www.linkedin.com/in/siddhi-singh07/">
          Siddhi Singh
        </Link>
      </p>
    </div>
